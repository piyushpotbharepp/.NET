...
namespace ConsoleApp10
{
    public class Shop_Details1
    {
        ...
        public void GetShop_Details1(string Shop_Name, string Shop_Description, int Shop_Keeper_Count, int Shop_Workers_Count)
        {
        ...
        public void DisplayShop_Details1()
        {
    ...
    class Inheritance
    {
        public static void Main()
        {
            ...
            Shop_Info.GetShop_Details1("Pallavi Pustakalaya", "Book Store", 2, 3);
            Shop_Info.GetShop_Details2("Stationary & General Store", "gg656yfuyyu5");
            Shop_Info.DisplayShop_Details1();
